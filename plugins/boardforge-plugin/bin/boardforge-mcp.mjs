...
const toolToJobType = {
  ...
  list_universal_board_scenarios: 'list_universal_board_scenarios',
  classify_board_complexity: 'classify_board_complexity',
  recommend_adaptive_stackup: 'recommend_adaptive_stackup',
  score_routability: 'score_routability',
  detect_constraint_conflicts: 'detect_constraint_conflicts',
  decide_structural_regeneration: 'decide_structural_regeneration',
  detect_template_reuse: 'detect_template_reuse',
  generate_board_specific_report: 'generate_board_specific_report',
  generate_placement_candidates: 'generate_placement_candidates',
  score_placement_candidates: 'score_placement_candidates',
  select_placement_candidate: 'select_placement_candidate',
  apply_universal_placement: 'apply_universal_placement',
  ...
  calculate_power_routing: 'calculate_power_routing',
  select_via_strategy: 'select_via_strategy',
  build_noise_map: 'build_noise_map',
  summarize_manufacturer_rules: 'summarize_manufacturer_rules',
  ...
  ingest_reference_design: 'ingest_reference_design',
  synthesize_circuit_blocks: 'synthesize_circuit_blocks',
  plan_production_pipeline: 'plan_production_pipeline',
  build_verified_demo_recipe: 'build_verified_demo_recipe',
  build_canonical_net_model: 'build_canonical_net_model',
  audit_asset_resolution: 'audit_asset_resolution',
  audit_placement_legality: 'audit_placement_legality',
  compile_routing_execution_strategy: 'compile_routing_execution_strategy',
  audit_release_export_gates: 'audit_release_export_gates',
  run_production_readiness_suite: 'run_production_readiness_suite',
  classify_board_architecture: 'classify_board_architecture',
  plan_hdi_manufacturing_strategy: 'plan_hdi_manufacturing_strategy',
  audit_return_path_integrity: 'audit_return_path_integrity',
  audit_creepage_clearance: 'audit_creepage_clearance',
  plan_bringup_reliability_matrix: 'plan_bringup_reliability_matrix',
  run_advanced_board_suite: 'run_advanced_board_suite',
  autotrace_board: 'autotrace_board',
  autotrace_critical_nets: 'autotrace_critical_nets',
  autotrace_power: 'autotrace_power',
  autotrace_signals: 'autotrace_signals',
  autotrace_diff_pairs: 'autotrace_diff_pairs',
  autotrace_remaining_nets: 'autotrace_remaining_nets',
  repair_routing: 'repair_routing',
  reroute_failed_nets: 'reroute_failed_nets',
  run_routing_drc: 'run_routing_drc',
  calculate_trace_width: 'calculate_trace_width',
  validate_trace_width: 'validate_trace_width',
  detect_power_neckdowns: 'detect_power_neckdowns',
  create_power_pour: 'create_power_pour',
  select_via_type: 'select_via_type',
  validate_via_manufacturability: 'validate_via_manufacturability',
  ...
  plan_pin_map_repairs: 'plan_pin_map_repairs',
  apply_pin_map_repairs: 'apply_pin_map_repairs',
  validate_3d_model_coverage: 'validate_3d_model_coverage',
  audit_bom_sourcing: 'audit_bom_sourcing',
  ...
  plan_copper_pours: 'plan_copper_pours',
  ...
  plan_autoroute_repair_loop: 'plan_autoroute_repair_loop',
  ...
  analyze_routing_congestion: 'analyze_routing_congestion',
  plan_escape_routing: 'plan_escape_routing',
  plan_diff_pair_tuning: 'plan_diff_pair_tuning',
  validate_power_integrity: 'validate_power_integrity',
  analyze_thermal_bottlenecks: 'analyze_thermal_bottlenecks',
  validate_assembly_orientation: 'validate_assembly_orientation',
  estimate_board_cost: 'estimate_board_cost',
  generate_engineering_questions: 'generate_engineering_questions',
  score_production_readiness: 'score_production_readiness',
  build_release_gate_report: 'build_release_gate_report',
