...
const routes = {
  ...
  'POST /jobs/validate-schematic-readiness': 'validate_schematic_readiness',
  ...
  'POST /jobs/autotrace': 'autotrace_board',
  'POST /jobs/autotrace-critical': 'autotrace_critical_nets',
  'POST /jobs/autotrace-power': 'autotrace_power',
  'POST /jobs/autotrace-signals': 'autotrace_signals',
  'POST /jobs/autotrace-diff-pairs': 'autotrace_diff_pairs',
  'POST /jobs/autotrace-remaining': 'autotrace_remaining_nets',
  'POST /jobs/repair-routing': 'repair_routing',
  'POST /jobs/reroute-failed-nets': 'reroute_failed_nets',
  'POST /jobs/routing-drc': 'run_routing_drc',
  'POST /jobs/calculate-trace-width': 'calculate_trace_width',
  'POST /jobs/validate-trace-width': 'validate_trace_width',
  'POST /jobs/detect-power-neckdowns': 'detect_power_neckdowns',
  'POST /jobs/create-power-pour': 'create_power_pour',
  'POST /jobs/select-via-type': 'select_via_type',
  'POST /jobs/validate-via-manufacturability': 'validate_via_manufacturability',
